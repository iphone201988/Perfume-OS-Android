...
import com.tech.perfumos.App
import com.tech.perfumos.BR
import com.tech.perfumos.R
import com.tech.perfumos.data.local.SharedPrefManager
import com.tech.perfumos.data.network.ErrorCodes
import com.tech.perfumos.data.network.NetworkError
import com.tech.perfumos.databinding.ViewProgressSheetBinding
import com.tech.perfumos.ui.base.connectivity.ConnectivityProvider
import com.tech.perfumos.utils.AlertManager
import com.tech.perfumos.utils.event.NoInternetSheet
...
abstract class BaseActivity<Binding : ViewDataBinding> : AppCompatActivity(),
    ...
    override fun onStateChange(state: ConnectivityProvider.NetworkState) {
        ...
        if (state.hasInternet()) {
            ...
            if (noInternetSheet?.isVisible == false && !supportFragmentManager.isStateSaved)
