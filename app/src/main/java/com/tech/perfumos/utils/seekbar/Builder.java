...
public class Builder {
    ...
    Drawable trackBackgroundDrawable = null;
    ...
    public Builder trackProgressDrawable(@NonNull Drawable d) {
        this.trackProgressDrawable = d;
        return this;
    }

    public Builder trackBackgroundDrawable(@NonNull Drawable d) {
        this.trackBackgroundDrawable = d;
        return this;
    }

    public Builder trackProgressDrawable(@DrawableRes int dRes) {
        this.trackProgressDrawable = ContextCompat.getDrawable(context, dRes);
        return this;
    }

    public Builder trackBackgroundDrawable(@DrawableRes int dRes) {
        this.trackBackgroundDrawable = ContextCompat.getDrawable(context, dRes);
        return this;
    }
